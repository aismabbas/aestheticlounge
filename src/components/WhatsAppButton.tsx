export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed right-7 bottom-7 z-[900] flex h-[60px] w-[60px] items-center justify-center rounded-full bg-whatsapp shadow-[0_4px_20px_rgba(37,211,102,0.35)] transition-all duration-300 hover:scale-[1.08] hover:shadow-[0_6px_30px_rgba(37,211,102,0.45)]"
    >
      {/* Pulse ring */}
